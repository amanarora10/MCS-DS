...
```
  ...
  * The lm_tt and tt_t seems to have same magnitude but opposite signs. The sign of t indicates which group mean A or B is used as a reference. It seems for linear regresion and t test they are swapped. 
