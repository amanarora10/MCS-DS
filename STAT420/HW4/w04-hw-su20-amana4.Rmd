...
* $\hat{\beta}_1$ indicates the rate of change of calories with each unit increase in  fat  with constant sugar and sodium.

* $\hat{\beta}_2$ indicates the rate of change of calories with each unit increase in  sugar  with constant fat  and sodium.

* $\hat{\beta}_3$ indicates the rate of change of calories with each unit increase in  sodium  with constant sugar and fat
...
summary_cal$sigma
```
* $s_y$ = `r sd(df$Calories)`
* $s_e$ = `r summary_cal$sigma`
...
* We prefer the 2nd model over 1st model since there is a statisicially significant improved accuracy. 
