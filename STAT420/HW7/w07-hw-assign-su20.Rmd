...
```
  ...
  * Based on the p-value of 0.074 we prefer this  interaction
...
* We can see now the t value sign and magnitude match and all.equal is returning TRUE. It seems t.test is using B as ref level. 
